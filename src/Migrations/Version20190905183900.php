 ...
 */
final class Version20190905183900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demandes ADD cgu TINYINT(1) NOT NULL, ADD piece_jointe VARCHAR(255) DEFAULT NULL, ADD hidden TINYINT(1) NOT NULL, ADD montant_remboursement DOUBLE PRECISION DEFAULT NULL, DROP code_postal, CHANGE client_id client_id INT DEFAULT NULL, CHANGE numero_dossier numero_dossier VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demandes ADD code_postal VARCHAR(5) DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP cgu, DROP piece_jointe, DROP hidden, DROP montant_remboursement, CHANGE client_id client_id INT NOT NULL, CHANGE numero_dossier numero_dossier INT DEFAULT NULL');
    }
}
