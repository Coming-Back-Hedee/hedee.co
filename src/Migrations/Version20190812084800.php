 ...
 */
final class Version20190812084800 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD swift_bic VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD iban VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
